    ...
    <div class="col-md-12">
        <section class="task-panel tasks-widget">
            <div class="panel-heading">
                <div class="pull-left">
                    <h5><i class="fa fa-tasks"></i>&nbsp; Usuarios</h5>
                </div>
                <br>
            </div>
            <div class="panel-body">
                            ...
                            <a href="<?php echo base_url()." admin/usuario/".$id[$i];?>" style="color: #797979">
                                <div class="task-title">
                                    <span class="task-title-sp">
                                        <?php echo $user[$i]; ?></span>
                                    <span class="badge <?php echo $tipos[$state[$i]]; ?>">
                ...
                <div class=" add-task-row">
                    <a class="btn btn-success btn-sm pull-right" href="<?php echo base_url()." admin/crearUsuario"; ?>">+ Agregar Usuario</a>
                </div>
            </div>
        </section>
    </div><!-- /col-md-12-->
